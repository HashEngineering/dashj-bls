...
public class G1ElementVector extends java.util.AbstractList<G1Element> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(G1ElementVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return DASHJBLSJNI.G1ElementVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    DASHJBLSJNI.G1ElementVector_doReserve(swigCPtr, this, n);
  }
