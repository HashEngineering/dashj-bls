...
public class Uint8VectorVector extends java.util.AbstractList<Uint8Vector> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(Uint8VectorVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return DASHJBLSJNI.Uint8VectorVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    DASHJBLSJNI.Uint8VectorVector_doReserve(swigCPtr, this, n);
  }
